...
with open("/Users/mlhossen/Desktop/moon_chap/dihedrals_calculation/combination_of_comp_1_2_3_for_2DHistogram.dat", "r") as f:
...
fig, (ax1,ax2,ax3) = plt.subplots(nrows=1, ncols=3, figsize = (18,6), gridspec_kw={'hspace': 0.01, 'wspace': 0.08})
...
ax1.set_xlabel(r"$\phi$" '(degree)', Fontsize=22)
...
ax2.set_xlabel(r"$\phi$" '(degree)', Fontsize=22)
...
cax = fig.add_axes([0.912,0.12655,0.03,0.755]) 
cbar = fig.colorbar(im, cax=cax)
cbar.ax.tick_params(labelsize=22)
plt.savefig("/Users/mlhossen/Desktop/moon_chap/dihedrals_calculation/combination_of_all_3_compound_new.png", dpi=1200)
plt.show()
